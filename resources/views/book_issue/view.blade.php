                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @php
                                            if($to > $returned){
                                                echo '<td style="background-color:red;color:#fff;">Time Exceeded !<br> <span class="text-center">-'.$diff_in_days.' days</span> <td>';
                                            }else if($diff_in_days <= 3){
                                                echo '<td style="background-color:salmon;color:#000;">'.$diff_in_days.' Days Remaining !<td>';
                                            }else{
                                                echo '<td>'.$diff_in_days.' Days Remaining
                                                <td>';
                                            }
                                            @endphp
                                            <td>
