...
<div class="main" style="min-height:600px;display:flex;align-items:center;padding:20px;">
    ...
    <form class="form-horizontal form-label-left" style="width:100%;margin-left:60px;" novalidate action="{{route('store.book')}}"
...
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="dept_id" value="{{ old('book_id') }}" class="form-control col-md-7 col-xs-12" name="book_id"
...
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="name" value="{{ old('book_title') }}" class="form-control col-md-7 col-xs-12" name="book_title"
...
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="name" value="{{ old('author') }}" class="form-control col-md-7 col-xs-12" name="author"
            required="required" type="text">
    </div>
</div>

<div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="book_dept">Department of Book<span
